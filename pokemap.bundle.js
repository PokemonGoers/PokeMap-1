...
(function() {
  function PokeMap(htmlElement, options) {
    ...
    function initStyles(mapId) {
      var styles = '<style>' + '#mapid .pokemon-details-popup {' + 'text-align: center;' + 'width: 300px; }' + '#mapid .pokemon-details-popup .pokemon-image {' + 'vertical-align: top;' + 'float: left;}' + '#mapid .pokemon-details-popup .pokemon-name {' + 'display: inline-block;' + 'margin-right: 15px;}' + '#mapid .pokemon-details-popup .details-block {' + 'text-align: left;' + 'margin-top: 5px;}' + '#mapid .pokemon-details-popup .details-attribute-name {' + 'font-weight: bold;' + 'padding-left: 5px;' + 'padding-right: 10px;' + 'font-size: 1.2em;}' + '#mapid .pokemon-details-popup .details-attribute-value {' + 'float: right;' + 'padding-top: 0.2em;}' + '</style>';
...
//# sourceURL=/Users/afedotov/Desktop/University/TUM/2 Semester/JS Technology/PokeMap-1/module/main.js
