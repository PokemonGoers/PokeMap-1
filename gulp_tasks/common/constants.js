...
var getRepository = function() {
    var repository = 'https://github.com/PokemonGoers/PokeMap-1.git';
    try {
...
module.exports = function() {
    ...
    var constants = {
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './node_modules/font-awesome/fonts/*.*', './node_modules/bootstrap/dist/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        serve: {
            ...
            localtunnel: false, // true, false or 'pokemap_1'
            ghostMode: {
                clicks: false,
                forms: false,
                scroll: false
